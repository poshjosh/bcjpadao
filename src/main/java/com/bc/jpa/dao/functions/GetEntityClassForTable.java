...
/**
 * @author Chinomso Bassey Ikwuagwu on Sep 25, 2018 9:18:21 PM
 */
public class GetEntityClassForTable implements BiFunction<String, Class, Class>, Serializable {
    ...
    public GetEntityClassForTable(Set<Class> entityClasses, Function<Class, String> getTableName) {
        this.entityClasses = Objects.requireNonNull(entityClasses);
