 ...
 */
public class ConvertToNumber<T extends Number> implements BiFunction<Object, Class<T>, Object> {

    private transient static final Logger LOG = Logger.getLogger(ConvertToNumber.class.getName());

    @Override
    public Object apply(Object value, Class<T> numberType) {
        return this.apply(value, numberType, null);
    }

    public Object apply(Object value, Class<T> numberType, Object outputIfNone) {
