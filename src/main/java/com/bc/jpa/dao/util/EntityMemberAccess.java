...
public interface EntityMemberAccess<E, e> {
    ...
    interface UpdateTest {
        boolean test(String name, Object srcValue, Object tgtValue);
    }
    ...
    int update(E entity, Map row, boolean convertCrossReferences);
    ...
    int update(E src, E target, UpdateTest test);
